...
export const PODCAST_EPISODES: PodcastEpisode[] = [
  ...
  },
  {
    ...
    description:
      "Jak zastavíme chaotické změny územního plánu díky dlouhodobému a koncepčnímu územnímu plánování? Proč trváme na přísnějších a vymahatelných smlouvách s developery? A jakou máme vizi pro areál kasáren, kde by mohli vzniknout nová městská knihovna evropského standardu, kulturní multifunkční sál nebo městské byty?",
    speakers: ["Barbora Skálová", "Martin Veselý", "Václav Kovář"],
    src: "/UP-final.mp3",
    spotifyUrl: "https://open.spotify.com/episode/4nzPqQaJk9eDF1OVYBpwWQ?si=d923a669b4f54aba",
    appleUrl:
      "https://podcasts.apple.com/us/podcast/v%C3%BDstavba-kterou-%C5%99%C3%ADd%C3%AD-m%C4%9Bsto-ne-develope%C5%99i/id6792550119?i=1000782903365",
  ...
  },
  {
    ...
    description:
      "Proč pětina Berouňáků odjíždí za prací jinam a co to znamená pro místní podnikatele? Jak můžou vypadat městské trhy, které lidi baví navštěvovat? A kde by v Berouně mohl vzniknout prostor pro nové firmy?",
    speakers: ["Lucie Šimečková"],
    src: "/Podnikani-final.mp3",
    spotifyUrl: "https://open.spotify.com/episode/1df2OFnVmWoIdcKxe97Fcb?si=141d8583d58a431e",
    appleUrl:
      "https://podcasts.apple.com/us/podcast/podnik%C3%A1n%C3%AD-pro-%C5%BEiv%C4%9Bj%C5%A1%C3%AD-beroun/id6792550119?i=1000787336442",
    youtubeUrl: "https://youtu.be/_V9IWzW8_Z0?si=wUqvTER7aJnjYED-",
    chapterLabel: "Beroun lokálně",
    chapterHref: "/program#lokalne",
  },
];

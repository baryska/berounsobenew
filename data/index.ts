...
export const Profiles = [
   ...
   },
  {
    ...
    photo: AV,
    text: `Absolvent MFF UK v Praze, obor teorie pravděpodobnosti. Jako pojistný matematik  přes 10 let pracoval 
    pro poradenskou společnost Deloitte, kde se podílel na řadě mezinárodních projektů v oblasti akvizic a fúzí pojišťoven, 
    tvorbě zátěžových testů, oceňování rizik z hlediska penzí, životního i neživotního pojištění.`,
  ...
  },
  {
    ...
    profession: "Softwarová vývojářka, lektorka programování",
    photo: BS,
  ...
  },
  {
    ...
    a manažer ve velké mezinárodní společnosti v několika zemích. Žila jsem v Londýně, Rennes, Bruselu a Budapešti.`,

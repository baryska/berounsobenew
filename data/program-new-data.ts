...
export const ALL_SEKCE: Sekce[] = [
  ...
  // },
  {
    ...
    color: "",
    headline: "Doprava řízená daty a chytrým plánem. Pocity nás kolon nezbaví.",
  ...
  },
  {
    ...
    color: "",
    headline: "Udržovaná sídliště a živé náplavky, na které budeme konečně pyšní.",
  ...
  },
  {
    ...
    color: "blue",
    headline: "Berounská karta plná výhod, aby žít v Berouně znamenalo radost.",
  ...
  {
    id: "ciste",
    eyebrow: "BEROUN ČISTĚ",
    color: "",
    headline: "Odpadové hospodářství, které řeší příčiny, ne až přeplněné kontejnery.",
    perex1: "Přejeme si, aby Beroun produkoval méně směsného odpadu a víc třídil. Je to správný cíl a stojíme si za ním. Aby to ale fungovalo, je potřeba se odpíchnout od dostupných dat a zajistit dostatečnou kapacitu.",
    perex2: "Město se počet nádob v posledních letech snažilo snižovat bez ohledu na realitu daného místa – výsledkem tak nebyla podpora třídění, ale <strong>přeplněná odpadová stání a záplava dalších pytlů kolem</strong>. Za svoz odpadu přitom každý v Berouně platíme roční poplatek. Je proto fér, abychom vybudovali systém, který bude směřovat k požadovaným cílům bez nepříjemných vedlejších efektů.",
    quote: "Ve vybírání poplatků za odpad umí být město velmi důsledné. Když člověk platí 1 000 Kč ročně, nebo jde o podnik, který se do systému poctivě přihlásil, očekává funkční službu. Každý jsme si ale někdy všimnul, že popelnice plní odpad, který tam nepatří, od lidí, kteří v Berouně nebydlí. Občan sám s tím nic nezmůže, nástroje k tomu má v ruce jen město. Jen by je muselo aktivně využívat. Chceme proto nastavit systém, který bude chránit ty, kdo odpady platí.",
    quoteName: "Jan Valachovič",
    quoteRole: "",
    quoteAvatar: "/Jan_valachovic.jpg",
    heroImage: "",
    weights: { rodina: 8, senior: 8, student: 5, auto: 2, mhd: 2, cyklista: 2, podnikatel: 8, sidliste: 10, miluji: 10 },
    points: [
      {
        id: "kapacita_dle_dat",
        heading: "Kapacitu nastavíme podle dat, ne odhadem od stolu",
        text: "Než se některé stanoviště zruší nebo se na něm ubere nádoba, musí město vědět, <strong>kolik odpadu tam skutečně vzniká a komu toto stanoviště reálně slouží</strong>. Zjistit se to dá, akorát se to dnes neděje. Kapacitu nádob i četnost svozu proto budeme upravovat <strong>podle zjištěných dat a podle jednotlivých lokalit, ne plošně</strong>. A tam, kde se počet nádob v minulosti snížil, ale stanoviště je od té doby dlouhodobě přetížené, rozhodnutí přezkoumáme. Přiznat, že se změna nepovedla, není prohra. Prohra je nechat to tak roky.",
        weights: { rodina: 9, senior: 9, student: 5, auto: 2, mhd: 1, cyklista: 1, podnikatel: 4, sidliste: 10, miluji: 10 },
      },
      {
        id: "odpad_z_podnikani",
        heading: "Férová pravidla pro všechny, kdo ve městě podnikají",
        text: "Většina berounských provozoven má odvoz odpadu poctivě zajištěný – buď ho řeší vlastním svozem, nebo má smlouvu s městem. Právě vůči nim není fér, když někdo tuhle povinnost obchází a <strong>odpad z podnikání odkládá do popelnic u bytových domů</strong>. Zabírá tím kapacitu, za kterou platí občané Berouna, a přenáší tak na ně náklady svého podnikání. Město přitom má v ruce nástroje pro kontrolu, jen je dnes z neznámých důvodů nevyužívá. <strong>Doklad o likvidaci odpadu si může vyžádat jedině město.</strong> Je to jeho práce a my bychom zařídili, že ji ve spolupráci s odborem životního prostředí a městské policie začne odvádět.",
        weights: { rodina: 6, senior: 6, student: 3, auto: 1, mhd: 1, cyklista: 1, podnikatel: 10, sidliste: 9, miluji: 10 },
      },
      {
        id: "pomoc_s_tridenim",
        heading: "Kde třídění vázne, navrhneme konkrétní pomoc",
        text: "Obecná výzva na webu situaci v jednom konkrétním odpadovém stání na sídlišti nezmění. Vysvětlování přijde na řadu až v okamžiku, kdy si ověříme, že lidem ve správném vyhazování a třídění odpadů nic nebrání. A to <strong>na místě, ne na úřední desce</strong>. Oslovíme předsedu SVJ, správce domu nebo vlastníka objektu a domluvíme se s nimi na praktickém postupu. Na nástěnce a přímo u popelnic se objeví <strong>jednoduchý a názorný návod</strong>, případně doručíme informaci až do schránek.\n\nJako město nesmíme jen dokola připomínat, že třídit je povinnost, kterou nařizuje zákon. <strong>Ukážeme, co se s vytříděným odpadem dál děje</strong>, jak se to promítá do čistoty okolí i do výdajů města. Protože snaha lidí, kteří třídí poctivě, rozhodně není zbytečná.",
        weights: { rodina: 8, senior: 8, student: 8, auto: 1, mhd: 1, cyklista: 2, podnikatel: 3, sidliste: 10, miluji: 10 },
      },
      {
        id: "smlouva_ave",
        heading: "Férová cena za čisté město. Zrevidujeme složitou smlouvu s AVE a zvážíme založení vlastní technické služby",
        text: "Každý rok platíme <strong>desítky milionů společnosti AVE</strong>, největšímu dodavateli města. Starají se o likvidaci odpadů, městskou zeleň i údržbu veřejného osvětlení. Smlouva s AVE se ale za poslední roky stala tak složitou, že už se v ní nikdo nevyzná. A proto se ptáme, nedodají městu tyto služby jiní dodavatelé levněji a kvalitněji? Nezvládne to město svépomocí? Je čas <strong>nastavení této spolupráce objektivně zhodnotit a porovnat s alternativními cestami</strong>.",
        weights: { rodina: 7, senior: 7, student: 4, auto: 2, mhd: 1, cyklista: 1, podnikatel: 8, sidliste: 7, miluji: 10 },
      },
    ],
  },
  {
    ...
    color: "",
    headline: "Školy podněcující zvědavost, které děti připraví na život i další studium.",
  ...
  },
  {
    ...
    color: "",
    headline: "Výstavba podle fér pravidel. Zájmy obyvatel chráníme před developery.",
    ...
    quoteName: "Martin Veselý",
    quoteRole: "",
    quoteAvatar: "/10_martin_vesely.png",
    heroImage: "",
    podcasts: [
      {
        src: "/UP-final.mp3",
  ...
  },
  {
    ...
    points: [
      ...
      {
        id: "mestske_casti",
        heading: "Beroun není jen centrum",
        text: "<strong>Zavadilka, Hostím, Zdejcina i Jarov</strong> jsou dlouhodobě přehlížené a my to chceme změnit. Nepřicházíme s nápady od stolu, sbíráme je přímo od vás, kdo v těchto městských částech žijete. Postaráme se o <strong>dokončení vodovodu a kanalizace v Hostímě i na Zavadilce</strong>, najdeme řešení pro <strong>hřiště na Zdejcině</strong> a vyřešíme <strong>parkování u kapličky na Jarově</strong>. Tím to ale jen začíná, protože vaše podněty nesmí dál končit v šuplíku, radnice se o ně musí aktivně zajímat.",
        weights: { rodina: 8, senior: 8, student: 5, auto: 7, mhd: 5, cyklista: 3, podnikatel: 4, sidliste: 6, miluji: 10 },
      },
    ],
  },
  {
    ...
    color: "",
    headline: "Podpora šikovných podnikatelů, od sdílených kanceláří po startovací obchody.",
  ...
  {
    id: "zdrave",
    eyebrow: "BEROUN ZDRAVĚ",
    color: "",
    headline: "Péče bez nekonečného obvolávání čísel, budovaná spolu se zdravotníky.",
    ...
    heroImage: "",
    weights: { rodina: 10, senior: 10, student: 5, auto: 1, mhd: 2, cyklista: 1, podnikatel: 3, sidliste: 6, miluji: 10 },
    points: [
      {
        id: "audit_dostupnosti",
        heading: "Během prvních sto dní zmapujeme situaci",
        text: "Získáme potřebná data a zahájíme diskuze se všemi stávajícími poskytovateli, abychom podpořili a doplnili chybějící zdravotnické profese. Pokud to bude potřeba, vytipujeme chybějící lékaře a budeme je motivovat například <strong>možností využít prostory města</strong>, případně rovnou nabídkou vybavené ordinace, kam lékař přijde s diplomem, ne s úvěrem. Lékařům bychom mohli nabídnout i sdílenou recepci, objednávkový systém, účetnictví a IT.",
        weights: { rodina: 8, senior: 8, student: 4, auto: 0, mhd: 1, cyklista: 0, podnikatel: 3, sidliste: 5, miluji: 10 },
      },
      {
        id: "startovaci_byty_zdravotnici",
        heading: "Startovací byty pro lékaře, zubaře i sestry",
        text: "Vyčleníme proto část <strong>městských startovacích bytů</strong> pro profese, které Beroun nejvíc potřebuje. Vedle učitelů tedy i pro lékaře, zubaře a sestry.\n\nNabídneme je výměnou za závazek zůstat ve městě, aby šlo o oboustranně férovou dohodu, ne o dárek. Nové byty vzniknou v areálu Tiba a v kasárnách, jak popisujeme v kapitole Beroun udržitelně.",
        weights: { rodina: 8, senior: 7, student: 7, auto: 0, mhd: 1, cyklista: 0, podnikatel: 4, sidliste: 5, miluji: 10 },
      },
      {
        id: "predani_praxe",
        heading: "Aby ordinace nezanikla s odchodem lékaře",
        text: "Berounu nehrozí jen to, že sem noví lékaři nepřijdou. Hrozí i to, že s odchodem toho stávajícího do důchodu <strong>zmizí celá ordinace i s kartotékou</strong>. Budeme proto aktivně pomáhat s předáním praxe, hledat nástupce, propojovat lidi a dát oběma stranám čas se domluvit.\n\nNabídneme také <strong>náborový příspěvek</strong> v oborech, které nám chybí nejvíc, pomůžeme se získáním rezidenčních míst pro mladé lékaře a zvážíme stipendium pro berounské mediky výměnou za závazek se sem po škole vrátit. U všech těchto podpor jde o veřejné peníze, a proto u každé předem řekneme, jaké jsou náklady a co za ně město dostane.",
        weights: { rodina: 8, senior: 10, student: 3, auto: 0, mhd: 1, cyklista: 0, podnikatel: 3, sidliste: 5, miluji: 10 },
      },
      {
        id: "prehled_ordinaci",
      ...
      {
        id: "telemedicina",
        heading: "Telemedicína tam, kde dává smysl",
        text: "Video hovor nenahradí zubaře. V řadě běžných situací ale ušetří čas: výsledek vyšetření, prodloužení receptu, kontrola po nemoci. Lékař ho pak může věnovat pacientům, kteří opravdu musí přijít, a pacient nemusí kvůli pěti minutám brát půlden volna.\n\nZanalyzujeme, co v Berouně dává smysl a co ne, a tam, kde to bude účelné, zavedení takové péče jako město zprostředkujeme nebo podpoříme. Bez velkých řečí o revoluci. Jako obyčejný nástroj, který někomu ušetří cestu.",
        weights: { rodina: 7, senior: 8, student: 6, auto: 2, mhd: 3, cyklista: 1, podnikatel: 4, sidliste: 4, miluji: 10 },
      },
      {
        id: "dusevni_zdravi_deti",
        heading: "Aby se dítě mělo komu svěřit",
        text: "Péče o duševní zdraví dětí je dnes tam, kde bývala zubní péče. Potřeba je obrovská a kapacita zlomková. Chceme, aby <strong>každé dítě v berounské škole mělo dostupné psychologické poradenství a pomoc</strong>. Školní psychology město neurčuje, může je ale dofinancovat, a hlavně může zařídit to podstatné: funkční cestu systémem, aby rodič ani učitel netápali, kam se obrátit a co bude dál.\n\nStejným směrem chceme podpořit i péči o duševní zdraví dospělých a seniorů, u kterých je dostupnost dnes ještě horší. Prioritou ale zůstávají děti, protože právě u nich má včasná pomoc největší vliv na celý další život.",
        weights: { rodina: 10, senior: 5, student: 8, auto: 0, mhd: 0, cyklista: 0, podnikatel: 2, sidliste: 4, miluji: 10 },
      },
      {
        id: "domaci_hospicova_pece",
        heading: "Nemoc nekončí za zdmi nemocnice",
        text: "Většina z nás si přeje strávit poslední období života doma, mezi svými. Aby to šlo, musí ve městě fungovat <strong>domácí péče, mobilní hospic a odlehčovací služby</strong> pro rodiny, které se starají o blízkého a samy potřebují jednou za čas vydechnout.\n\nZmapujeme potřeby obyvatel a připravíme plán rozvoje domácí a hospicové péče. Poskytovatele těchto služeb podpoříme tak, aby jejich dostupnost byla jistá dlouhodobě, ne rok od roku. Pečující rodiny dnes odvádějí obrovský kus práce, který by jinak musel zaplatit stát nebo město. Zaslouží si, aby na to nebyly samy.",
        weights: { rodina: 7, senior: 10, student: 2, auto: 0, mhd: 1, cyklista: 0, podnikatel: 2, sidliste: 5, miluji: 10 },
      },
    ],
  },
  {
    ...
    quoteName: "Jakub Novák",
    quoteRole: "",
    quoteAvatar: "/8_jakub_novak.png",
    heroImage: "",
    weights: { rodina: 8, senior: 9, student: 5, auto: 0, mhd: 2, cyklista: 0, podnikatel: 4, sidliste: 8, miluji: 10 },
    points: [
      {
        id: "deti_a_chudoba",
        heading: "Aby děti neplatily za to, jak se zrovna daří rodičům",
        text: "Podle Mapy vzdělávání od PAQ Research nedokončí na Berounsku základní vzdělání <strong>2,7 % dětí</strong>. Je to lepší než celostátní průměr 3,6 %, ale pořád je za tím číslem každý rok několik konkrétních dětí z našich škol. A skoro vždycky se dá zpětně ukázat, kde to začalo: chybějící pomůcky, brýle, obědy, výlet, na který se nejelo.\n\nZpřehledníme a zjednodušíme cestu k zapojení všech potřebných školáků a předškoláků do existujících programů zajišťujících <strong>obědy zdarma na všech berounských školách a školkách</strong> – bez zbytečné administrativy či stigmatizace jednotlivých rodin či dětí. Jsme si dobře vědomi nákladů spojených se školou či kroužky, a proto chceme rovněž koordinovat a rozvíjet různé formy <strong>pomoci s financováním výletů, kroužků či pomůcek</strong> tak, aby se mohly děti rozvíjet bez ohledu na aktuální finanční situaci jejich rodičů.",
        weights: { rodina: 10, senior: 3, student: 4, auto: 0, mhd: 1, cyklista: 0, podnikatel: 2, sidliste: 7, miluji: 10 },
      },
      {
        id: "dluhove_poradenstvi",
        heading: "Do dluhů se dnes dostane i člověk, který by to o sobě neřekl. Tak to být nemá.",
        text: "Není to tak, jak si většina z nás představuje. <strong>Čtyři z deseti lidí v exekuci jsou v Berouně starší padesáti let.</strong> Stačí rozvod, nemoc, ztráta práce nebo ručení za někoho blízkého. A málokdy zůstane u jedné jediné exekuce: na každého z těch tisíce lidí připadá průměrně pět řízení naráz. Přesně tak vypadá past, ze které se vlastními silami nevyhrabe skoro nikdo.\n\nRozšíříme proto <strong>dostupnost dluhového poradenství</strong>, a to pro každého, kdo se do potíží dostane, bez ohledu na výši příjmu. Propojíme ho s úřadem práce i se zaměstnavateli ve městě, protože ti o problému často vědí dřív než kdokoli jiný. A budeme srozumitelně informovat o tom, jak funguje oddlužení a kdy má smysl do něj jít. Čím dřív se člověk dozví, že vůbec nějakou možnost má, tím levněji to skončí pro všechny.",
        weights: { rodina: 7, senior: 10, student: 4, auto: 0, mhd: 1, cyklista: 0, podnikatel: 5, sidliste: 8, miluji: 10 },
      },
      {
        id: "mesto_nevyrabi_dluzniky",
        heading: "Zavedeme opatření, aby naše město nevyrábělo vlastní dlužníky",
        text: "Když někdo nezaplatí za odpad nebo za nájem v městském bytě, dnešní postup je jednoduchý: upomínka, penále, exekutor. Z dluhu pár set korun je během chvíle dluh za desetitisíce a člověk, který ho nikdy nedokáže splatit. Město na přísnosti nic nevydělá, navíc přijde i o původní částku. A jen přidá další exekuci člověku, který jich má většinou už několik.\n\nUděláme to jinak. <strong>Beroun má vlastní exekuční pravomoc</strong> a nemá důvod své pohledávky předávat exekutorům, vymáhat si je umíme sami. Po první nezaplacené platbě zavoláme a <strong>nabídneme splátkový kalendář</strong>, místo abychom rovnou posílali upomínku. Nejde nám o odpouštění dluhů, ale o to, vymáhat je tak, aby to pro člověka nebylo likvidační a pro město výnosnější.",
        weights: { rodina: 6, senior: 8, student: 3, auto: 0, mhd: 1, cyklista: 0, podnikatel: 4, sidliste: 9, miluji: 10 },
      },
      {
        id: "centrum_bydleni",
        heading: "Zavedeme koncept bydlení, které si lidé dokáží udržet",
        text: "Nejlepší nástroj, jaký má samospráva v bytové politice v ruce, je <strong>vlastní bytový fond</strong>. Budeme ho proto rozšiřovat i opravovat a začneme městskými byty v areálu Tiba, o kterých píšeme v kapitole Beroun udržitelně.\n\nVedle toho zřídíme <strong>městské centrum bydlení</strong>. Jedno místo, kam si člověk může přijít pro pomoc dřív, než o střechu nad hlavou přijde. Poradí s žádostí o příspěvek na bydlení, s kaucí i se snižováním nákladů za energie. Bezpečné místo k životu je totiž podmínkou toho, aby se člověk mohl vrátit do práce a k normálnímu životu. Nesmí to být až odměna po splnění.",
        weights: { rodina: 8, senior: 9, student: 8, auto: 0, mhd: 2, cyklista: 0, podnikatel: 2, sidliste: 8, miluji: 10 },
      },
      {
        id: "zavislosti",
        heading: "Závislosti se budeme snažit léčit. Vyhnat je z města nejde.",
        text: "Osvětlení, kamery a pořádek kolem popelnic patří k tomu, aby se lidé ve svém okolí cítili dobře a bezpečně. Samy o sobě ale problém nevyřeší, jen ho posunou o ulici dál. Aby v podchodu neležely jehly, musí ve městě být někdo, kdo drogově závislé zná a umí s nimi pracovat.\n\nZajistíme proto <strong>stabilní víceleté financování kontaktního centra a terénní práce</strong>, aby se tyhle služby nemusely každý rok doprošovat o rozpočet. A posílíme prevenci na školách, protože nejlevnější závislost je ta, která nikdy nezačne.",
        weights: { rodina: 7, senior: 8, student: 5, auto: 0, mhd: 2, cyklista: 1, podnikatel: 4, sidliste: 9, miluji: 10 },
      },
    ],
  },
];
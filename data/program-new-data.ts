...
const SEKCE_CHYTRE: Sekce = {
  ...
  perex1: 'Nechceme, aby každá návštěva úřadu vyžadovala půlden volna z práce. Vytvoříme proto moderní systém služeb občanům, který vám reálně usnadní život. Od platby za odpady přes žádost o doklady až po nákup lístků do kina, vše vyřešíte v jediné aplikaci Beroun v mobilu. Digitálně a bez fyzické návštěvy. Pokud tedy samozřejmě nebudete chtít přijít.',
